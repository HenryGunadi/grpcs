...
import (
	...
	"github.com/HenryGunadi/grpcs/services/orders/handler"
...
func NewOrderAPIServer(addr string) *APIServer {
	return &APIServer{
		addr: addr,
	}
}
...
func (s *APIServer) Run() error {
	...
	orderServiceHandler := handler.NewOrderHTTPHandler(conn)
	orderServiceHandler.RegisterRoutes(router)
